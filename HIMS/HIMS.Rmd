...
cpmg <- local(get(load(paste0(dataPath, "/hims_C1_PLA_HIMrXX_PROF.PLASMA.CPMG.daE"))))
noesy <- local(get(load(paste0(dataPath, "/hims_C1_PLA_HIMrXX_PROF.PLASMA.NOESY.daE"))))
...
noesy100G1@obsDescr[[1]]['category'] = 'Heart_Attack'
...
cpmg100G1@obsDescr[[1]]['category'] = 'Heart_Attack' 
...
noesy100G2@obsDescr[[1]]['category'] = 'Control' 
...
cpmg100G2@obsDescr[[1]]['category'] = 'Control' 
...
write.table(dfHIMS[dfHIMS$experiment=="PROF_PLASMA_CPMG", ], file="data_HIMS_cpmg.tsv", sep="\t", row.names = FALSE, quote=FALSE)
write.table(dfHIMS[dfHIMS$experiment=="PROF_PLASMA_NOESY", ], file="data_HIMS_noesy.tsv", sep="\t", row.names = FALSE, quote=FALSE)
